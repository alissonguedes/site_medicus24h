<table>
	<thead>
		<tr>
			<th class="left-align">Especialidade</th>
	...
	<tbody>
		@foreach ($especialidades as $row)
			...
			<tr>
				...
				<td class="center-align">
					<button class="btn btn-small btn-flat btn-edit btn-floating transparent" data-href="{{ route('clinica.especialidades.edit', $row->id) }}" data-tooltip="Editar" data-trigger="form" data-target="main-form">
