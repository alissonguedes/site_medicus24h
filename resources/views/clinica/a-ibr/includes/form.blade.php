<x-header-page data-href="{{ route('admin.a-ibr.index') }}" placeholder="Pesquisar postagem..." title="Adicionar Postagem">add</x-header-page>
...
<x-slot:form action="{{ route('admin.a-ibr.post') }}" method="post" style="{{ $errors->any() || request('id') ? 'display: block; transform: translateY(-100%);' : 'display: none; transform: translateY(0%);' }}" autocomplete="off">
