					...
					<div class="row">
						<div class="col s12 m4 l4">
							<div class="input-field">
								<div class="row">
									<div class="col s12">
										<label for="clinica" class="active strong black-text">Agendar para a clínica:</label>
										<br>
										<small class="grey-text">Informe a clínica onde o médico atenderá esta agenda.</small>
									</div>
								</div>
								<div class="row">
									<div class="col s12">
