...
<div id="modal_programa" class="modal modal-fixed-footer">
	<div class="modal-content">
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field">
					...
					<input type="text" name="nome_programa" id="nome_programa">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field">
					<label for="nome_programa">Faixa etária</label>
					<input type="text" name="nome_programa" id="nome_programa">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field">
					<label for="nome_programa">Sexo</label>
					<input type="text" name="nome_programa" id="nome_programa">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col s12">
				<div class="input-field">
					<label for="nome_programa">Grupo do programa</label>
					<input type="text" name="nome_programa" id="nome_programa">
				</div>
			</div>
		</div>
