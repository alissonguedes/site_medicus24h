					...
					<div class="col s12 m6 l4">
						<div class="card">
							<div class="card-image">
								...
								<span class="card-title white-text m-0" style="background-color: rgba(0, 0, 0, 0.3); width: 100%;">{{ $paciente->nome }}</span>
								<button class="btn-floating halfway-fab waves-effect waves-light red" data-trigger="form" data-target="main-form" data-href="{{ route('clinica.homecare.pacientes.edit', $paciente->id) }}" style="z-index: 9999999"><i class="material-icons">edit</i></button>
							</div>
