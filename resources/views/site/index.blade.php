        ...
        <nav class="navbar-color navbar-fixed z-depth-0">
            <div class="nav-wrapper">
                <h1 class="no-margin no-padding">
                    <a href="#" class="brand-logo skew">
                        <img src="{{ asset('assets/img/logo/logo.png') }}" alt="">
                    </a>
                </h1>
                <ul id="nav-mobile" class="right hide-on-med-and-down letterspacing">
                    <li><a href="#" class="skew active">Início</a></li>
                    <li><a href="#" class="skew">Sobre Nós</a></li>
                    <li><a href="#" class="skew">Serviços</a></li>
                    <li><a href="#" class="skew">ClubMédicus24h</a></li>
                    <li><a href="#" class="skew">Atendimento</a></li>
                </ul>
            </div>
        </nav>
    </header>
        ...
        <div id="slider">
            <div class="slider fullscreen">
                <ul class="slides">
                    @for ($i = 1; $i <= 2; $i++)
                        <li>
                            <img src="{{ asset('assets/img/site/banner/ambulancia.png') }}"
                                class="animated delay-3s fadeInRight"
                    ...
                    <div class="row">
                        @for ($i = 0; $i < 3; $i++)
                            <div class="col s12 m3 l4">
                                <div class="card-panel card-animation-1 card z-depth-0 border teal lighten-1">
                                    <img src="{{ asset('assets/img/site/cards/ambulancia.jpg') }}" alt=""
                                        class="responsive-img border-radius-8 z-depth-0 image-n-margin">
                                    <h6 class="card-title">
