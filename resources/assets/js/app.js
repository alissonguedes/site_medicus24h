...
$(document).ready(function () {
	...
	// $('.confirm_delete:before,.confirm_delete:after').bind('click', function() {
	...
	$('[type="button"].delete').unbind().bind('click', function (e) {
		...
		$('.confirm_delete#' + target).toggleClass('open');

		// $('.confirm_delete').toggleClass('open');

		// var modal = $('#confirm_delete').modal({

		// 	onOpenStart: function(m) {
